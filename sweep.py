...
VARIANTS = [
    ("A. Baseline 5% / score 0.15 / fixed TP",
     {"position_pct": 0.05, "min_score": 0.15, "exit_mode": "tp"}),
    ("B. 5% / score 0.30 (new default)",
     {"position_pct": 0.05, "min_score": 0.30, "exit_mode": "tp"}),
    ("C. 5% / score 0.40 (very selective)",
     {"position_pct": 0.05, "min_score": 0.40, "exit_mode": "tp"}),
    ("D. 5% / score 0.30 + trail EMA20",
     {"position_pct": 0.05, "min_score": 0.30, "exit_mode": "trail"}),
    ("E. 5% / score 0.30 + TP then trail",
     {"position_pct": 0.05, "min_score": 0.30, "exit_mode": "tp_then_trail"}),
    ("F. 5% / 0.30 / hybrid + RS>0",
     {"position_pct": 0.05, "min_score": 0.30, "exit_mode": "tp_then_trail",
      "require_rs": True}),
